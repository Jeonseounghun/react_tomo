...
const section_join = () => {
  return (
    <div>
      <section className="join1 active">
        ...
        <section className="condition_container">
          <div className="condition1">
            ...
            <div className="check__icon">
              동의<i className="fas fa-check-circle"></i>
            </div>
